...
export function Contact(): React.ReactElement {
  ...
  return (
    <section id="contact" ref={sectionRef} className="flex flex-col">
      {/* Top: Vision split */}
      <div className="py-24 px-8 md:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl font-extralight tracking-tight leading-[1.1] text-[#0e0e0c]">
      ...
      <div className="bg-[#F5F2ED] w-full">
        <div
          ref={formRef}
          className="flex flex-col md:flex-row w-full px-8 md:px-12 py-32 md:py-48 items-baseline max-w-7xl mx-auto"
        >
          {/* Left: heading */}
          <motion.div
          ...
          >
            <h2 className="font-serif text-6xl md:text-8xl font-light tracking-tight text-[#0e0e0c]">
              Let&apos;s Work
              <br />
              Together
            </h2>
